...
const Dio = ({ turnAnimation, bossHp, bossAttack, stun, showAttackNumber, attackNumber, bossHpChange, bossAttackAnimation }) => {
  return (
    <div className='boss-container'>
        ...
        <GiPadlock className={`stun-chain ${stun.stunAnimation && 'on-stun'}`} />
            <div className='card-content card-content-front'>
              <div className={`stat-circle stat-circle-left yellow-dark`}>
                <p className='stat-indicator'>{bossAttack}</p>
              </div>
              <div className={`stat-circle stat-circle-right yellow-dark ${bossHpChange ? 'onhit' : ''}`}>
                <p className='stat-indicator'>{bossHp}</p>
              </div>
              <div className={`img-container`}>
                <img className={`card-img boss-img yellow ${bossAttackAnimation ? 'animate__animated animate__tada' : ''}`} alt='' src={'cardImg/dio3.jpg'} />
              </div>
              <div className={`inner-card yellow`}>
                <div className='inner-card-content boss-title'>
                  <div className={`card-title-container yellow-dark`}>
                    <h1 className='card-title'>Dio Brando</h1>
                  </div>
                </div>
              </div>
            </div>
